  ...
  return (
    <div style={{ overflow: "hidden" }}>
      ...
      <section style={{ textAlign: "center", padding: "4rem 1rem 3rem", position: "relative" }}>
        ...
        <div style={{ position: "relative" }}>
          ...
          <div style={{ display: "inline-flex", alignItems: "center", gap: "0.5rem", background: "rgba(56,189,248,0.08)", border: "1px solid rgba(56,189,248,0.2)", borderRadius: 20, padding: "4px 16px", marginBottom: "1.5rem", fontSize: "0.82rem", color: "var(--sky)" }}>
            ...
            Live — {stats ? stats.total?.toLocaleString() : "2.4M+"} devices protected
          </div>
      ...
      <section style={{ display: "grid", gridTemplateColumns: "repeat(4,1fr)", gap: "1px", background: "var(--border)", borderRadius: "var(--r-xl)", overflow: "hidden", marginBottom: "4rem", border: "1px solid var(--border)" }}>
        {[
          [stats?.total || 2400000,    "",   "Devices Protected", "var(--sky)"],
          [stats?.openReports || 18000,"",   "Active Cases",      "var(--rose)"],
      ...
      <section style={{ marginBottom: "4rem" }}>
        ...
        <p style={{ textAlign: "center", color: "var(--muted)", marginBottom: "2rem" }}>Real stories from users who got their devices back</p>

        <div style={{ display: "grid", gridTemplateColumns: "repeat(auto-fit,minmax(280px,1fr))", gap: "1rem" }}>
          {TESTIMONIALS.map((t,i) => (
            <div key={i} className="card" style={{ position: "relative" }}>
              <div style={{ fontSize: "2rem", color: "var(--sky)", opacity: 0.3, position: "absolute", top: "1rem", right: "1.25rem", lineHeight: 1 }}>"</div>
              <p style={{ color: "var(--text2)", fontSize: "0.9rem", lineHeight: 1.7, marginBottom: "1rem", fontStyle: "italic" }}>"{t.text}"</p>
