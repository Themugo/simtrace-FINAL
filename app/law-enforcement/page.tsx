    ...
    <div>
      ...
      <div style={{ display: "flex", alignItems: "center", gap: "1rem", marginBottom: "1.5rem", flexWrap: "wrap" }}>
        ...
        <div style={{ marginLeft: "auto", display: "flex", gap: "0.5rem", alignItems: "center" }}>
          <a href="/law-enforcement-compliance" className="btn-ghost" style={{ padding: "6px 14px", fontSize: "0.82rem", border: "1px solid var(--border)", textDecoration: "none", display: "inline-flex", alignItems: "center", gap: "0.4rem" }}>
            ⚖️ Data Residency & Compliance Monitor
          </a>
          {isPartner && (
            <span style={{ background: "rgba(52,211,153,0.1)", color: "var(--emerald)", padding: "4px 14px", borderRadius: 20, fontSize: "0.75rem", fontWeight: 700 }}>
              ✓ VERIFIED PARTNER
            </span>
          )}
        </div>
