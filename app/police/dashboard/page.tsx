...
export default function PoliceDashboard() {
  ...
  return (
    <div>
      ...
      <div className="card" style={{ background: 'linear-gradient(135deg, rgba(14,165,233,0.08), rgba(99,102,241,0.08))', border: '1px solid var(--sky)33' }}>
        <div style={{ display: 'flex', alignItems: 'center', justifyContent: 'space-between', flexWrap: 'wrap', gap: '1rem' }}>
          <div>
            <h3 style={{ fontSize: '1.05rem', margin: '0 0 0.25rem 0', display: 'flex', alignItems: 'center', gap: '0.5rem' }}>
              🧠 AI Investigation & Neural Intelligence Suite
            </h3>
            <p className="text-muted" style={{ fontSize: '0.85rem', margin: 0 }}>
              Access AI OCR scanning, natural language query search, automated court affidavits, theft probability scoring & alert triage.
            </p>
          </div>
          <Link href="/ai-assistant" className="btn-primary" style={{ textDecoration: 'none', padding: '8px 16px', fontSize: '0.85rem' }}>
            Open AI Platform →
          </Link>
        </div>
      </div>
