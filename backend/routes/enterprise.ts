...
router.patch("/organizations/:id", authenticate, requireOrgAdmin("id"), async (req: AuthRequest, res: Response, next: NextFunction) => {
  try {
    const { id } = req.params;
...
router.post("/organizations/:id/upgrade", authenticate, requireOrgAdmin("id"), async (req: AuthRequest, res: Response, next: NextFunction) => {
  try {
    const schema = z.object({
...
router.post("/organizations/:id/members", authenticate, requireOrgAdmin("id"), async (req: AuthRequest, res: Response, next: NextFunction) => {
  try {
    const schema = z.object({
      userId: z.string(),
...
router.delete("/organizations/:id/members/:userId", authenticate, requireOrgAdmin("id"), async (req: AuthRequest, res: Response, next: NextFunction) => {
  try {
...
router.patch("/organizations/:id/members/:userId", authenticate, requireOrgAdmin("id"), async (req: AuthRequest, res: Response, next: NextFunction) => {
  try {
    const schema = z.object({
