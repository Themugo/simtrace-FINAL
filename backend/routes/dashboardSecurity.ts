...
import { z } from "zod";
import { authenticate, requireAdmin, requireRole, requireSelfOrAdmin } from "../middleware/auth.js";
import {
  createOfficialEmail,
  verifyOfficialEmail,
  getOfficialEmail,
...
router.get("/official-emails/:emailId", authenticate, requireRole("admin", "super_admin"), async (req: AuthRequest, res: Response, next: NextFunction) => {
  try {
    const { emailId } = req.params;
...
router.get("/official-emails/user/:userId", authenticate, requireSelfOrAdmin("userId"), async (req: AuthRequest, res: Response, next: NextFunction) => {
  try {
...
router.get("/security-otps/:otpId", authenticate, requireRole("admin", "super_admin"), async (req: AuthRequest, res: Response, next: NextFunction) => {
  try {
    const { otpId } = req.params;
...
router.get("/security-otps/user/:userId", authenticate, requireSelfOrAdmin("userId"), async (req: AuthRequest, res: Response, next: NextFunction) => {
  try {
    const { userId } = req.params;
...
router.post("/password-resets/:requestId/approve", authenticate, requireRole("admin", "super_admin"), async (req: AuthRequest, res: Response, next: NextFunction) => {
  try {
    const schema = z.object({
...
router.post("/password-resets/:requestId/reject", authenticate, requireRole("admin", "super_admin"), async (req: AuthRequest, res: Response, next: NextFunction) => {
  try {
    const schema = z.object({
...
router.post("/password-resets/:requestId/complete", authenticate, requireRole("admin", "super_admin"), async (req: AuthRequest, res: Response, next: NextFunction) => {
  try {
    const schema = z.object({
...
router.get("/password-resets/:requestId", authenticate, requireRole("admin", "super_admin"), async (req: AuthRequest, res: Response, next: NextFunction) => {
  try {
    const { requestId } = req.params;
...
router.get("/password-resets/user/:userId", authenticate, requireSelfOrAdmin("userId"), async (req: AuthRequest, res: Response, next: NextFunction) => {
  try {
    const { userId } = req.params;
...
router.post("/network-changes", authenticate, requireRole("telecom", "admin", "super_admin"), async (req: AuthRequest, res: Response, next: NextFunction) => {
  try {
    const schema = z.object({
      requesterId: z.string(),
...
router.post("/network-changes/:requestId/approve", authenticate, requireRole("telecom", "admin", "super_admin"), async (req: AuthRequest, res: Response, next: NextFunction) => {
  try {
    const schema = z.object({
...
router.post("/network-changes/:requestId/reject", authenticate, requireRole("telecom", "admin", "super_admin"), async (req: AuthRequest, res: Response, next: NextFunction) => {
  try {
    const schema = z.object({
      rejectionReason: z.string(),
    });
...
router.post("/network-changes/:requestId/execute", authenticate, requireRole("telecom", "admin", "super_admin"), async (req: AuthRequest, res: Response, next: NextFunction) => {
  try {
    const schema = z.object({
...
router.post("/network-changes/:requestId/rollback", authenticate, requireRole("telecom", "admin", "super_admin"), async (req: AuthRequest, res: Response, next: NextFunction) => {
  try {
    const schema = z.object({
...
router.get("/network-changes/:requestId", authenticate, requireRole("law_enforcement", "telecom", "admin", "super_admin"), async (req: AuthRequest, res: Response, next: NextFunction) => {
  try {
    const { requestId } = req.params;
...
router.get("/network-changes/agency/:agencyId", authenticate, requireRole("law_enforcement", "telecom", "admin", "super_admin"), async (req: AuthRequest, res: Response, next: NextFunction) => {
  try {
...
router.get("/access-logs/user/:userId", authenticate, requireSelfOrAdmin("userId"), async (req: AuthRequest, res: Response, next: NextFunction) => {
  try {
    const { userId } = req.params;
...
router.post("/dashboards/minister", authenticate, requireRole("admin", "super_admin"), async (req: AuthRequest, res: Response, next: NextFunction) => {
  try {
    const schema = z.object({
      ministerId: z.string(),
...
router.get("/dashboards/minister/:ministerId", authenticate, requireRole("law_enforcement", "admin", "super_admin"), async (req: AuthRequest, res: Response, next: NextFunction) => {
  try {
...
router.patch("/dashboards/minister/:dashboardId", authenticate, requireRole("admin", "super_admin"), async (req: AuthRequest, res: Response, next: NextFunction) => {
  try {
...
router.post("/dashboards/police-general", authenticate, requireRole("admin", "super_admin"), async (req: AuthRequest, res: Response, next: NextFunction) => {
  try {
    const schema = z.object({
...
router.get("/dashboards/police-general/:policeGeneralId", authenticate, requireRole("law_enforcement", "admin", "super_admin"), async (req: AuthRequest, res: Response, next: NextFunction) => {
  try {
...
router.patch("/dashboards/police-general/:dashboardId", authenticate, requireRole("admin", "super_admin"), async (req: AuthRequest, res: Response, next: NextFunction) => {
  try {
    const { dashboardId } = req.params;
...
router.post("/dashboards/station-admin", authenticate, requireRole("admin", "super_admin"), async (req: AuthRequest, res: Response, next: NextFunction) => {
  try {
    const schema = z.object({
...
router.get("/dashboards/station-admin/:stationAdminId", authenticate, requireRole("law_enforcement", "admin", "super_admin"), async (req: AuthRequest, res: Response, next: NextFunction) => {
  try {
...
router.patch("/dashboards/station-admin/:dashboardId", authenticate, requireRole("admin", "super_admin"), async (req: AuthRequest, res: Response, next: NextFunction) => {
  try {
    const { dashboardId } = req.params;
...
router.get("/dashboards/user/:userId", authenticate, requireSelfOrAdmin("userId"), async (req: AuthRequest, res: Response, next: NextFunction) => {
  try {
    const { userId } = req.params;
