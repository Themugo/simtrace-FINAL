...
router.get('/', async (req: Request, res: Response, next: NextFunction) => {
  try {
    ...
    // Check database connection. Dynamic ESM import exposes the mongoose singleton
    // under `.default`, so read the connection from there (reading `.connection`
    // off the namespace object is undefined and was making this always report
