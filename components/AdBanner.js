...
export default function AdBanner({ placement = "dashboard_banner", style: extraStyle = {} }) {
  const { user }    = useAuth();
  ...
  return (
    <div style={{
      ...
      <div style={{ flex: 1, minWidth: 0 }}>
        ...
        <div style={{ fontSize: "0.78rem", color: "var(--muted)", marginTop: 2, overflow: "hidden", display: "-webkit-box", WebkitLineClamp: 2, WebkitBoxOrient: "vertical" }}>{ad.body}</div>
      </div>
